...
namespace bookshop.Migrations
{
    ...
    [Migration("20181124194734_Mig_CustomClaims3")]
    partial class Mig_CustomClaims3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("bookshop.Models.BookInstPhoto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<int>("BookInstId");
                    ...
                    b.HasIndex("BookInstId");

                    b.ToTable("BookInstPhotos");
                });
            ...
            modelBuilder.Entity("bookshop.Models.CustomClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("bookshop.Models.UserCustomClaim", b =>
                {
                    b.Property<int>("UserId");

                    b.Property<int>("CustomClaimId");

                    b.HasKey("UserId", "CustomClaimId");

                    b.HasIndex("CustomClaimId");

                    b.ToTable("UserCustomClaim");
                });
            ...
            modelBuilder.Entity("bookshop.Models.BookInstPhoto", b =>
                {
                    b.HasOne("bookshop.Models.BookInst", "BookInst")
                        .WithMany()
                        .HasForeignKey("BookInstId")
                        .OnDelete(DeleteBehavior.Cascade);
                });

            modelBuilder.Entity("bookshop.Models.UserCustomClaim", b =>
                {
                    b.HasOne("bookshop.Models.CustomClaim", "CustomClaim")
                        .WithMany()
                        .HasForeignKey("CustomClaimId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("bookshop.Models.User", "User")
                        .WithMany("UserCustomClaims")
